...
#print(x.shape) # x형태  (506,13)    -> 칼럼하나 줄여서 12 만들어서 (506,2,2,3) 4차원 형태로 conv2d로 받아서 cnn모델링가능
...
model = Sequential()
model.add(Conv2D(100,kernel_size=(2,2),strides=1,padding='same', input_shape=(2,2,3), activation='relu'))    # 2,2,10                                                                           # 1,1,10
...
#### 결과
#loss :  17.776628494262695
#r2스코어 :  0.8205351251613021

# loss :  9.998618125915527
# r2스코어 :  0.8990584413292194
