...
from tensorflow.keras.datasets import fashion_mnist        ##패션엠니스트
...
model = Sequential()
model.add(Conv2D(10, kernel_size=(3,3), input_shape=(28, 28, 1)))  # (9, 9, 10) 으로 변환된다 행렬곱 연산이라서 10은 마지막 노드의 갯수, 고정값
model.add(Conv2D(50, (3, 3), activation='relu'))                   # (7, 7,  5) 9-3+1 = 7
model.add(Flatten())
model.add(Dense(20))
