...
print(x_train.shape)    # (105, 2, 2, 1)
print(x_test.shape)     # (45, 2, 2, 1)


#2.모델링

model = Sequential()
model.add(Conv2D(100,kernel_size=(2,2),strides=1,padding='same', input_shape=(2,2,1), activation='relu'))    # 2,2,10                                                                           # 1,1,10
...
#### 결과
#loss :  0.031671181321144104
#r2스코어 :  0.9549619753875224