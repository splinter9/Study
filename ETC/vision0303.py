...
submission = pd.read_csv('D:\\_data\dacon\\computer\\sample_submission.csv')


path = '../_data/dacon/computer/test/' # 모든 이미지를 불러오는 함수
...
save_path = 'D:\\Study\\_data\dacon\\computervision\\vision_0302_4.csv'
