...
from tensorflow.keras.layers import Dense, Conv2D, LSTM, Conv1D, Flatten, Dropout, Activation,MaxPooling2D
...
model = Sequential()
model.add(Conv2D(900,kernel_size = (3,3), activation='relu', input_shape = (3,4,1)))
