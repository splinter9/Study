...
# print(outliers_loc)
# print(datasets.loc[[[255], 'Garage Yr Blt']==2207].index, inplace=True)
...
# def xg_def(max_depth, learning_rate, n_estimators,min_child_weight, 
#              subsample, 
...
# print(min_dict)
# {'target': 0.10178187744591273, 'params': {'colsample_bytree': 0.25802259218738116, 'learning_rate': 0.19674345226228057, 'max_depth': 3.2594251790053494, 'min_child_weight': 0.7386348945376919, 'n_estimators': 8993.492838504666, 'reg_lambda': 9.326912892215942, 'subsample': 0.9528405326740957}}
# {'target': 0.0889741708929552, 'params': {'colsample_bytree': 0.82311593825603, 'learning_rate': 0.11520475945944177, 'max_depth': 6.9197971182170015, 'min_child_weight': 2.0886940750281138, 'n_estimators': 8293.453105466275, 'reg_lambda': 6.869905678724954, 'subsample': 0.7027705719420436}}
