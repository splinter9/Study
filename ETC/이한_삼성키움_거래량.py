...
x1=sam.drop(range(50,1120), axis=0)
x2=kim.drop(range(50,1060), axis=0)
...
x1 = np.array(x1)
x2 = np.array(x2)
print(x1.shape, x2.shape)  #(25, 2) (25, 2)
...
dense1=LSTM(150, activation='relu', name='dense1')(input1)
dense2=Dense(80, activation='relu', name='dense2')(dense1)
dense3=Dense(50, activation='relu', name='dense3')(dense2)
output1=Dense(2, activation='linear', name='dense4')(dense3)

input2=Input(shape=(5,1))
dense11=LSTM(150, activation='relu', name='dense11')(input2)
dense12=Dense(80, activation='relu', name='dense12')(dense11)
dense13=Dense(50, activation='relu', name='dense13')(dense12)
dense14=Dense(10, activation='relu', name='dense14')(dense13)
output2=Dense(5, activation='linear', name='output2')(dense14)
...
output23 = Dense(10, activation='linear')(output22)
last_output1 = Dense(3)(output23)

output31 = Dense(70)(merge1)
output32 = Dense(20)(output31)
output33 = Dense(20, activation='relu')(output32)
output34 = Dense(10, activation='linear')(output33)
...
model.save("D:\\_data\\exam\\삼성키움_거래량.h5")

es = EarlyStopping(monitor='val_loss', patience=100, mode='auto', verbose=1, restore_best_weights=True)
# mcp=ModelCheckpoint(monitor='val_loss', mode='auto', verbose=1,save_best_only=True)

start=time.time()
model.fit([x1_train, x2_train],[y1_train, y2_train], epochs=1000, batch_size=8, validation_split=0.2, verbose=1, callbacks=[es])
end=time.time()-start
...
#예상거래량 :  삼성전자 15071210.0  / 키움증권 65485.21
#예상거래량 :  삼성전자 11755468.0  / 키움증권 97179.77
