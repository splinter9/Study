...
kim = kim.drop(range(893,1060), axis=0) #키움증권도 삼성전자와 행을 맞춰준다
...
dense1_3 = Dense(30, activation='relu')(dense1_2)
output1 = Dense(10, activation='linear')(dense1_3)

#키움증권 모델 input
input2 = Input(shape=(4,))
dense2_1 = Dense(50, activation='relu')(input2)
dense2_2 = Dense(60, activation='relu')(dense2_1)
dense2_3 = Dense(40, activation='relu')(dense2_2)
...
output1_2 = Dense(50)(output1_1)
output1_3 = Dense(20)(output1_2)
...
model.fit([x1_train, x2_train], [y1_train, y2_train], 
          epochs=1000, batch_size=16, validation_data=([x1_val, x2_val], [y1_val, y2_val]), callbacks=[es])
